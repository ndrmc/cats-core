...
public class OperationController {
	...
	public Operation createDispatch(@RequestBody @Valid final Operation operation) {
	...
	public Operation getDispatchById(@PathVariable Long id) {		
	...
	public Operation getDispatchbyGin(@PathVariable String name) {
	...
	public Operation updateDispatch(@RequestBody @Valid final Operation operation) throws NotFoundException {
	...
	public List<Operation> listDispatches() {		
	...
	public List<Operation> listDispatchesByYear(@PathVariable String year) {		
